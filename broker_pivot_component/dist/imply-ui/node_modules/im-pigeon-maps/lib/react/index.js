...
var Map = function (_Component) {
  ...
  function Map(props) {
    ...
    _this.handleMouseDown = function (event) {
      ...
      if (event.button === 0 && !(0, _parentHasClass2.default)(event.target, 'pigeon-drag-block') && _this.coordsInside(pixel)) {
        _this.stopAnimating();
        event.preventDefault();
  ...
  _createClass(Map, [{
    ...
    value: function () {
      var _props3 = this.props,
          attribution = _props3.attribution,
          attributionPrefix = _props3.attributionPrefix;
    ...
    value: function () {
      var _props4 = this.props,
          ...
          zoomOnMouseWheel = _props4.zoomOnMouseWheel;
      ...
      return _infact.React.createElement('div', { style: {
        ...
        ref: this.setRef,
        onWheel: zoomOnMouseWheel ? this.handleWheel : undefined }, this.renderTiles(), this.renderOverlays(), this.renderAttribution());
    }
  }]);
...
Map.propTypes = {
  ...
  zoomOnMouseWheel: _infact.PropTypes.bool,
